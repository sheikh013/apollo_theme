...
gulp.task('vendorCss', function () {
    return gulp.src(root_folder + '/assets/css/vendor/*.css')
    ...
    //.pipe(sourcemaps.write())
        ...
        .pipe(cssMinify())
        .pipe(gulp.dest(root_folder + '/assets/css/'))
        .pipe(notify({message: 'Vendor CSS task completed', onLast: true}));
...
gulp.task('vendorJs', function () {
    ...
    var $vendor_path = ['assets/js/vendor/**/*.js', '!assets/js/vendor/customizer.js'];
    ...
    //.pipe(sourcemaps.write())
        ...
        .pipe(jsMinify())
        .pipe(gulp.dest(root_folder + '/assets/js/'))
        .pipe(notify({message: 'Vendor Javascript task completed', onLast: true}));

});
//==============================================================================
// == MINIFY  CUSTOM JS IN CUSTOM JS
// FOLDER=========================================== GET CUSTOMS.JS FILE
gulp.task('customJs', function () {
    return gulp.src(root_folder + '/assets/js/custom/**/*.js')
